...
class Solution {
    ...
    TreeNode subOptimalDFS(int[] preorder, int[] inorder) {
    ...
    root.left = subOptimalDFS(leftPre, leftIn);
    ...
    root.right = subOptimalDFS(rightPre, rightIn);

    return root;

  }
    public TreeNode buildTree(int[] preorder, int[] inorder) {
        return subOptimalDFS(preorder, inorder);
    }
}
